...
# Terraform deployment script that automatically uses variables from the secrets folder
# This script makes it easy to deploy infrastructure with secrets properly configured
